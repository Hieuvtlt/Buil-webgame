(() => {
  ...
  // Pushes a random battlefield coordinate toward the outer ring while keeping
  // the center stable. This makes the opening formation look like units are
  // entering from the surrounding area, while the existing combat movement logic
  // continues to own the real coordinates.
  ...
  function attach(field) {
    ...
    const observer = new MutationObserver((mutations) => {
      ...
      if (changed) applyMonsterEdgeBias(field);
    });

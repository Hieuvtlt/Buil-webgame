    ...
    <div class="craft-screen game-screen craft-forging">
      <div class="craft-layout">
        <section class="craft-main-panel">
          <div class="craft-machine-frame"><img class="craft-machine-art craft-machine-art-forge" src="${assetBase}assets/craft/hammer-anvil.svg" alt="Búa và đe luyện khí"></div>

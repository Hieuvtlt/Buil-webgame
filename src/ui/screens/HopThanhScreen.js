    ...
    <div class="craft-screen game-screen">
      <div class="craft-layout">
        <section class="craft-main-panel">
          <div class="craft-machine-frame"><img class="craft-machine-art craft-machine-art-fusion" src="${assetBase}assets/images/hinhhopthanh.svg" alt="Khung hợp thành"></div>

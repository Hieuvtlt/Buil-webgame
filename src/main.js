...
import { mountCombatSystem } from './ui/CombatSystem.js'
import { mountMapSystem } from './ui/MapSystem.js'
...
const screens={
  'Nhân vật':{render:CharacterScreen,mount:mountCharacterScreen},'Túi đồ':{render:InventoryScreen,mount:mountInventoryScreen},'Kỹ năng':{render:SkillsScreen,mount:mountSkillsScreen},'Luyện đan':{render:LuyenDanScreen},'Luyện khí':{render:LuyenKhiScreen},'Hợp thành':{render:HopThanhScreen,mount:mountHopThanhScreen},'Thương hội':{render:ThuongHoiScreen,mount:mountMerchantScreen},'Nhiệm vụ':{render:NhiemVuScreen,mount:mountNhiemVuScreen},'Ngoại cảnh':{render:NgoaiCanhScreen,mount:mountNgoaiCanhScreen},'GM':{render:GMScreen},'Cài đặt':{render:SettingsScreen}
}
